...
public class ServerWordCounterFrame extends JFrame{
	...
	public ServerWordCounterFrame () {
		...
		this.setTitle("Word Counter: Server Side");
		...
		this.lblCounterWord = new JLabel();  
		
		
		
		
		// Row, Column
		this.txtRequestStatus  = new JTextArea(10, 70);
	...
	private JPanel displayWordsAndCount() {
		
		JPanel panel = new JPanel();
		
		panel.add(lblCounterWord);
	...
	public void updateWordCount(int counter, String sentence) {
		
		lblCounter.setFont(new Font("Sans Serif", Font.PLAIN, 24));
		lblCounterWord.setFont(new Font("Sans Serif", Font.PLAIN, 24));
		lblCounter.setBackground(Color.WHITE);
		lblCounterWord.setBackground(Color.WHITE);
		this.lblCounter.setText(" has a total word of " + String.valueOf(counter));
		this.lblCounterWord.setText("' " + sentence + " '");
	}
	...
	public void loadComponent() {
		...
		JPanel southPanel = this.displayWordsAndCount();
